...
- isCorrect: false
  text: je fais confiance au site sur le fait qu’il ne me rajoute pas d’article ou
    service en plus.
correction: Il existe beaucoup de sites et services qui se permettent d’ajouter des
  articles dans votre panier sans vous demander votre avis. Il est important de toujours
  revérifier le contenu de son panier avant de le valider.
goodPractices:
