...
correction: Si vous recevez une pièce jointe que vous n’attendiez pas, soyez prudent,
  c’est peut-être un virus informatique. N’ouvrez pas immédiatement la pièce jointe
  et tester plutôt sa fiabilité avec un logiciel de type Antivirus ou Sandbox d’abord.
  Vous pouvez aussi faire une levée de doute en contactant le proche via un autre
  moyen.
goodPractices:
