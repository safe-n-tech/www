...
- isCorrect: false
  text: 'utiliser un pseudonyme basé sur mon nom raccourci (Ex. : Dupont devient dpt).'
- isCorrect: true
  text: utiliser un pseudonyme auquel on ne peut pas me relier.
correction: 'Utiliser un pseudonyme sur les réseaux sociaux est un moyen de préserver
  sa vie privé et son identité. '
goodPractices:
