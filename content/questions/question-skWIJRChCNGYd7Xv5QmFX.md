...
correction: Si vous devez envoyer une donnée personnelle, comme une carte d’identité,
  à un proche, des précautions sont à prendre ! En effet, une boîte mail n’est pas
  infaillible, et un pirate peut facilement tomber dessus et l’utiliser sans votre
  consentement. Dans ce cas, il est important de transmettre cette information en
  main propre, ou si ce n’est pas possible, d’apposer un filigrane sur le scan ou
  la photo pour éviter la réutilisation de la donnée.
goodPractices:
