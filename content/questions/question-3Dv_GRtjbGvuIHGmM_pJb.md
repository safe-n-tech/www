...
- isCorrect: true
  text: De faire les mises à jour manuellement dès qu'une nouvelle mise à jour est
    disponible
correction: Activer les mises à jour automatiques vous permet de ne pas oublier de
  faire les mises à jour, et donc de disposer d’une version optimale et sécurisé de
  votre logiciel.
goodPractices:
